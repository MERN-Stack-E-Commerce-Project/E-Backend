...
//   Cart.findOne({ user: req.user._id }).exec((error, data) => {
//     if (error) {
//       return res.status(400).json({ error });
//     }
//     if (data) {
//       let promiseArray=[];
//        console.log("addtocart ",req.body.cartItems);
...
//     if(cart){
//       let cartItems={};
//       // console.log("cart.catrIttesmd",cart.cartItems);
//       cart.cartItems.forEach((item,indx)=>{
